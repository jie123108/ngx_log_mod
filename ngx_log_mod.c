...
char* ngx_http_bizlog_init(ngx_conf_t *cf, bizlog_svr_conf_t *cscf)
{
...
//static char* ngx_http_bizlog_mod(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);
...
static ngx_http_module_t  ngx_http_bizlog_module_ctx = {
...
ngx_module_t  ngx_http_bizlog_module = {
    NGX_MODULE_V1,
    &ngx_http_bizlog_module_ctx, /* module context */
    ngx_http_bizlog_commands,   /* module directives */
    NGX_HTTP_MODULE,               /* module type */
    NULL,                          /* init master */
    NULL,                          /* init module */
    &ngx_http_bizlog_init_process, /* init process */
    NULL,                          /* init thread */
    NULL,                          /* exit thread */
    NULL,      /* exit process */
    NULL,      /* exit master */
